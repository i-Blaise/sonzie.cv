                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i class="ti-wallet me-1 ms-1"></i>
                                    My Balance</a>
                                <a class="dropdown-item" href="../logout.php"><i class="mdi mdi-exit-to-app me-1 ms-1"></i>
                                    Logout</a>
                            </ul>
                        </li>
                        <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <h5 class="card-subtitle">Edits cant be deleted, only updated. So triple check your edits before updating</h5>
                            <form class="form-horizontal mt-4" method="POST">
                            <div class="form-group">
                                    <label>About Me Text</label>
                                    <textarea class="form-control" name="aboutDesc" rows="5" require></textarea>
                                </div>
                                <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success text-white" name="submit" value="Submit">Update About Desc</button>
                                        </div>
                                </div>
                            </form>
                            ...
                            <form class="form-horizontal mt-4" method="POST">
                                <div class="form-group">
                                    <label>Website <span class="help"> e.g. "www.sonzie.online"</span></label>
                                    <input type="text" class="form-control" require>
                                </div>
                                <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success text-white" name="submit" value="Submit">Update Website</button>
                                        </div>
                                </div>
                            </form>
                            ...
                            <form class="form-horizontal mt-4" method="POST">
                                <div class="form-group">
                                    <label for="example-email">Degree </label>
                                    <input type="text" id="example-email" name="example-email" class="form-control"
                                        placeholder="e.g. 'Masters In Business Admin.'" require>
                                </div>
                                <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success text-white" name="submit" value="Submit">Update Degree</button>
                                        </div>
                                </div>
                            </form>
